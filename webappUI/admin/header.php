...
<head>
	...
	<link rel="shortcut icon" href="asset/favicon.ico111">
            ...
            <div class="navbar-header" style="width:100%;">
              <div class="opener-left-menu is-open">
                ...
                <a href="index.html" class="navbar-brand"> 
                 <img src="asset/img/mymobi.jpg" style="width:55px;height: 35px">
                </a>

              <ul class="nav navbar-nav navbar-right user-nav">
                <li class="user-name"><span>Fridah Kinya</span></li>
            ...
            <div id="left-menu">
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
					...
					<li class="ripple"><a href="index.php"><span class="icons icon-people"></span>Users</a></li>
					<!--<li class="ripple">
